                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select autocomplete="off" class="form-control post-type"
                                                        name="type">
                                                        <option {{ $post->type == 'post' ? 'selected' : '' }}
                                                            value="post">
                                                            وبلاک</option>
                                                        <option {{ $post->type == 'match' ? 'selected' : '' }}
                                                            value="match">
                                                            مسابقه</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select autocomplete="off" class="form-control" name="status">
                                                        <option value="pending"
                                                            {{ $post->status == 'pending' ? 'selected' : '' }}>در حال ثبت
                                                            نام
                                                        </option>
                                                        <option value="published"
                                                            {{ $post->status == 'published' ? 'selected' : '' }}>منتشر شده
                                                        </option>
                                                        <option value="finished"
                                                            {{ $post->status == 'finished' ? 'selected' : '' }}>به اتمام
                                                            رسیده
                                                        </option>
                                                        <option value="deactive"
                                                            {{ $post->status == 'deactive' ? 'selected' : '' }}>غیر فعال
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/posts/edit.js') }}?v=51"></script>
@endpush
