                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount"
                                                                            ...
                                                                            <option data-value="1000000" value="1000000"
                                                                                {{ $copy_product && $copy_product->rounding_amount == '1000000' ? 'selected' : '' }}>
                                                                                1000000 ریال</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-3">
                                            <fieldset class="checkbox">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="sizebandi" >
                                                    <span class="vs-checkbox">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                                                    </span>
                                                    <span>محصول سایزبندی؟</span>
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/products/all.js') }}?v=51"></script>
    <script src="{{ asset('back/assets/js/pages/products/create.js') }}?v=51"></script>
@endpush
