    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <!-- filter start -->
                @include('back.products.partials.filters', [
                    'filter_action' => route('admin.product.prices.index'),
                ])
                <!-- filter end -->
                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li>
                                            <button type="button"
                                                class="btn btn-outline-primary waves-effect waves-light save-price-changes"><i
                                                    class="fa fa-save"></i> ذخیره تغییرات</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                        ...
                                                        @foreach ($product->prices as $price)
                                                            <div class="row my-1">
                                                                ...
                                                                <div class="col-md-3 text-center">
                                                                    <input
                                                                        class="form-control form-control-sm ltr text-center amount-input"
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input
                                                                        class="form-control form-control-sm ltr text-center"
                                                                        name="products[{{ $product->id }}][prices][{{ $price->id }}][stock]"
                                                                        value="{{ $price->stock }}" type="number"
                                                                        {{ $price->product->isDownload() ? 'readonly' : '' }}>
                                                                </div>
                            ...
                            <div class="card-footer text-center">
                                <div class="heading-elements">
                                    <ul class="list-inline d-block mb-0">
                                        <li>
                                            <button type="button"
                                                class="btn btn-outline-primary waves-effect waves-light save-price-changes">
