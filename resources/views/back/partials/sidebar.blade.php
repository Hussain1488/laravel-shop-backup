<div class="main-menu menu-fixed menu-accordion menu-shadow {{ user_option('theme_color') == 'light' ? 'menu-light' : 'menu-dark' }}"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (optional(Auth::user()->store)->exists())
                @can('cooperationsales')
                    <li class="nav-item has-sub {{ open_class(['admin.shop_more.*']) }}"><a href="#"><i
                                class="feather icon-shopping-cart"></i><span class="menu-title"> بیشتر</span></a>
                        <ul class="menu-content">
                            <li class="{{ active_class('admin.shop_more.more') }}">
                                <a href="{{ route('admin.shop_more.more', [Auth::user()->store->id]) }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">اطلاعات و گالری عکس ها
                                    </span></a>
                            </li>

                            <li class="{{ active_class('admin.shop_more.index') }}">
                                <a href="{{ route('admin.shop_more.index', [Auth::user()->store->id]) }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">نظرات
                                    </span></a>
                            </li>
                        </ul>
                    </li>
            ...
            @if (optional(Auth::user()->store)->exists())
                @can('cooperationsales')
                    <li class="nav-item has-sub {{ open_class(['admin.employee.*']) }}"><a href="#"><i
                                class="feather icon-user"></i><span class="menu-title"> پرسنل</span></a>
                        <ul class="menu-content">
                            <li class="{{ active_class('admin.employee.index') }}">
                                <a href="{{ route('admin.employee.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">لیست پرسنل</span></a>
                            </li>

                            <li class="{{ active_class('admin.employee.create') }}">
                                <a href="{{ route('admin.employee.create') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">ایجاد پرسنل</span></a>
                            </li>

                            <li class="{{ active_class('admin.employee.review') }}">
                                <a href="{{ route('admin.employee.review') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">نظرات پرسنل</span></a>
                            </li>
                        </ul>
                    </li>
                @endcan
            ...
            @if (optional(Auth::user()->store)->exists())
                @can('cooperationsales')
                    <li class="nav-item has-sub {{ open_class(['admin.services.*']) }}"><a href="#"><i
                                class="feather icon-sunrise"></i><span class="menu-title"> امکانات</span></a>
                        <ul class="menu-content">
                            <li class="{{ active_class('admin.services.index') }}">
                                <a href="{{ route('admin.services.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">لیست امکانات </span></a>
                            </li>

                            <li class="{{ active_class('admin.services.create') }}">
                                <a href="{{ route('admin.services.create') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">ایجاد امکانات</span></a>
                            </li>

                            <li class="{{ active_class('admin.services.review') }}">
                                <a href="{{ route('admin.services.review') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item">نظرات امکانات</span></a>
                            </li>
                        </ul>
                    </li>
                @endcan
            ...
            @can('operatoractivity')
                <li class="nav-item has-sub {{ open_class(['admin.operatoractivity.*']) }}"><a href="#"><i
                            class="feather icon-users"></i><span class="menu-title">اپراتورها</span></a>
                    <ul class="menu-content">
                        @can('operatoractivity.index')
                            <li class="{{ active_class('admin.operatoractivity.*') }}">
                                <a href="{{ route('admin.operatoractivity.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item">لیست اپراتور </span></a>
                            </li>
                        @endcan
                    ...
                    <ul class="menu-content">
                        @can('installmentpurchase.index')
                            <li class="{{ active_class('admin.installmentpurchase.index') }}">
                                <a href="{{ route('admin.installmentpurchase.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item"> اقساط </span></a>
                            </li>
                        @endcan
                    ...
                    <ul class="menu-content">
                        ...
                        @can('installmentreports.payRequestList')
                            <li class="{{ active_class('admin.installmentreports.payRequestList') }}">
                                <a href="{{ route('admin.installmentreports.payRequestList') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item"> لیست درخواست های تسویه
                                    </span></a>
                            </li>
                        @endcan
            ...
            @can('posts')
                <li class="nav-item has-sub {{ open_class(['admin.posts.*']) }}"><a href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @endcan
                        <li class="{{ active_class('admin.participant.index') }}">
                            <a href="{{ route('admin.participant.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item">لیست شرکت کننده ها</span></a>
                        </li>
                        <li class="{{ active_class('admin.participant.postIndex') }}">
                            <a href="{{ route('admin.participant.postIndex') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item">لیست پست ها</span></a>
                        </li>
                    ...
                    <ul class="menu-content">
                        ...
                        @can('products.stock-notify')
                            <li class="{{ active_class('admin.stock-notifies.index') }}">
                                <a href="{{ route('admin.stock-notifies.index') }}"><i class="feather icon-circle"></i><span
                                    ...
                                    <li class="{{ active_class('admin.brands.index') }}">
                                        <a class="{{ active_class('admin.brands.index') }}"
                                            href="{{ route('admin.brands.index') }}"><i
                                                class="feather icon-circle"></i><span class="menu-item">لیست برندها</span></a>
                                    </li>
                                    <li class="{{ active_class('admin.brands.create') }}">
                                        <a class="{{ active_class('admin.brands.create') }}"
                                            href="{{ route('admin.brands.create') }}"><i
                                                class="feather icon-circle"></i><span class="menu-item">ایجاد برند</span></a>
                                    </li>
                                </ul>
                            </li>
                        @endcan
        ...
        @can(['comments'])
            <li class="nav-item has-sub {{ open_class(['admin.comments.*']) }}"><a href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ active_class('admin.reviews.shop') }} nav-item">
                        <a href="{{ route('admin.reviews.shop') }}">
                            <i class="feather feather icon-circle"></i>
                            <span class="menu-title"> نظرات فروشگاه</span>
                        </a>
                    </li>
                    <li class="{{ active_class('admin.reviews.employee') }} nav-item">
                        <a href="{{ route('admin.reviews.employee') }}">
                            <i class="feather feather icon-circle"></i>
                            <span class="menu-title"> نظرات پرسنل</span>
                        </a>
                    </li>
                    <li class="{{ active_class('admin.reviews.service') }} nav-item">
                        <a href="{{ route('admin.reviews.service') }}">
                            <i class="feather feather icon-circle"></i>
                            <span class="menu-title"> نظرات امکانات</span>
                        </a>
                    </li>
                    <li class="{{ active_class('admin.comments.state') }} nav-item">
                        <a href="{{ route('admin.comments.state') }}">
                            <i class="feather feather icon-circle"></i>
                            <span class="menu-title"> نظرات وضعیت</span>
                        </a>
                    </li>
