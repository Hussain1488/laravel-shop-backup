...
@section('content')
                    ...
                    <div class="card-content" id="main-card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped mb-0 state_datatable"
                                    action='{{ route('admin.participant.postDatatable') }}'>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    با حذف پست دیگر قادر به بازیابی آن نیستید.
                </div>
                <div class="modal-footer">
                    <form action="#" id="state-delete-form" method="POST">
                        @csrf
                        {{-- @method('delete') --}}
                        <input type="hidden" name='id' value id="state-id">
                        <button type="button" class="btn btn-success waves-effect waves-light"
                            data-dismiss="modal">خیر</button>
                        <button type="button" class="btn btn-danger waves-effect waves-light delete-state-submit">بله حذف
                            شود</button>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade text-left" id="state-edit-modal" tabindex="-1" role="dialog" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg stat-edit-content" role="document">
                        ...
                        <div class="participant-stat m-1 border rounded-md">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="dropzone dropzone-area mb-2 participant-images" id="participant-images">
    ...
    <div class="modal fade text-left" id="state-show-modal" tabindex="-1" role="dialog" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content" id="stat-content"></div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/participant/stateIndex.js') }}"></script>
@endpush
