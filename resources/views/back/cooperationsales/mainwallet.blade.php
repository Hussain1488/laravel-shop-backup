                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                {!! $key->user
                                                                    ? 'تسویه فاکتور مشتری: ' .
                                                                        $key->user->username .
                                                                        '<br /> تاریخ پرداخت فروش: ' .
                                                                        \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($key->pre_paid_time))->format('Y/m/d H:i:s')
                                                                    : '...' !!}
                                                            ...
                                                            <span class="text-dark">
                                                                {!! $key->user
                                                                    ? 'تسویه فاکتور مشتری: ' .
                                                                        $key->user->username .
                                                                        '<br /> تاریخ پرداخت فروش: ' .
                                                                        \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($key->pre_paid_time))->format('Y/d/m H:i:s')
                                                                    : '...' !!}
                                                            </span>
                                                        </div>
                                                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/installmentsReport/create.js') }}?v=51"></script>
@endpush
