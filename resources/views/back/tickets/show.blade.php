                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <dd class="col-md-6">
                                                        ...
                                                        <a href="{{ route('admin.users.show', ['user' => $ticket->user]) }}"
                                                    ...
                                                    @if ($loop->first)
                                                        <div class="divider">
                                                            <div class="divider-text">
                                                                {{ jdate($message->created_at)->ago() }}</div>
                                                        </div>
                                                    @endif

                                                    @if ($message->user->id != auth()->user()->id)
                                                        @include('back.tickets.partials.message', [
                                                            'own' => true,
                                                        ])
                                                    @else
                                                        @include('back.tickets.partials.message', [
                            ...
                            <div id="main-card" class="card-content">
                                <div class="card-body">
                                    <div class="col-12 col-md-10 offset-md-1">
                                        <form class="form" id="ticket-update-form"
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="dropzone dropzone-area mb-2" id="ticket-file-dropzone"
                                                            data-url="{{ route('admin.tickets.file.store') }}"
                                                            data-remove-url="{{ route('admin.tickets.file.destroy') }}">
                                                            <div class="dz-message  h-auto">فایل ها را به اینجا بکشید</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button type="submit"
                                                            class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ارسال
                                                            پیام</button>
                                                    </div>
                                                </div>
                                            </div>
