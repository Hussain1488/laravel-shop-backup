                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-control" name="status" id="filter-status">
                                                    ...
                                                    <option value="unconfirmed"
                                                        {{ request('status') == 'unconfirmed' ? 'selected' : '' }}>تایید
                                                        نشده</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($comments as $comment)
                                                    <tr id="comment-{{ $comment->id }}-tr">
                                                        ...
                                                        <td>{{ $comment->user ? $comment->user->fullname : $comment->name }}
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" data-comment="{{ $comment->id }}"
                                                                class="btn btn-success mr-1 waves-effect waves-light show-comment">مشاهده</button>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/comments/state.js') }}"></script>
@endpush
