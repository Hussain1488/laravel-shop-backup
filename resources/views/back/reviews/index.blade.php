                                                ...
                                                @foreach ($reviews as $review)
                                                    <tr id="review-{{ $review->id }}-tr">
                                                        ...
                                                        <td style="max-width: 200px">
                                                            <span
                                                                class="d-inline-block">{{ $review->product->title }}</span>
...
@push('scripts')
    <script src="{{ asset('back/assets/js/pages/reviews/index.js') }}?v=51"></script>
@endpush
