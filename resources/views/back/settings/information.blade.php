                                    ...
                                    <form id="information-form" action="{{ route('admin.settings.information') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>استان</label>
                                                    <select id="province" data-action="{{ route('provinces.get-cities') }}"
                                                        name="info_province_id" class="form-control">
                                                        @foreach ($provinces as $province)
                                                            <option value="{{ $province->id }}"
                                                                @if ($province->id == option('info_province_id')) selected @endif>
                                                    ...
                                                    <select id="city" name="info_city_id" class="form-control">
                                                        @foreach ($cities as $city)
                                                            <option value="{{ $city->id }}"
                                                                @if ($city->id == option('info_city_id')) selected @endif>
                                                                {{ $city->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input id="tags" type="text" name="info_tags"
                                                        class="form-control" value="{{ option('info_tags') }}">
                                                </fieldset>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <select name="multi_language_enabled" class="form-control">
                                                            <option value="0"
                                                                {{ option('multi_language_enabled', '0') == 0 ? 'selected' : '' }}>
                                                                خیر</option>
                                                            <option value="1"
                                                                {{ option('multi_language_enabled') == '1' ? 'selected' : '' }}>
                                                                بله</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <select name="reserve_orders_enabled" class="form-control">
                                                            <option value="0"
                                                                {{ option('reserve_orders_enabled', '0') == 0 ? 'selected' : '' }}>
                                                                خیر</option>
                                                            <option value="1"
                                                                {{ option('reserve_orders_enabled') == '1' ? 'selected' : '' }}>
                                                                بله</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="reserve_orders_page_link"
                                                            class="form-control"
                                                            value="{{ option('reserve_orders_page_link') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="site_rules_page_link"
                                                            class="form-control"
                                                            value="{{ option('site_rules_page_link') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>مدت زمان لغو خودکار سفارشات پرداخت نشده <small>(به
                                                                دقیقه)</small></label>
                                                        <input type="numer" name="orders_cancel_time"
                                                            class="form-control"
                                                            value="{{ option('orders_cancel_time', 60) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row p-0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input info_map_type"
                                                        id="info_map_type_google" name="info_map_type" value="google"
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input info_map_type"
                                                        id="info_map_type_mapir" name="info_map_type" value="mapir"
                                                        {{ option('info_map_type') == 'mapir' ? 'checked' : '' }}>
...
@include('back.partials.plugins', [
    'plugins' => ['jquery-tagsinput', 'jquery.validate', 'mapp', 'google-map'],
])
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/settings/information.js') }}?v=51"></script>
