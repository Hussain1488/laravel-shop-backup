            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5 col-md-7 col-12 mx-auto">
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <form id="forgot-password-form" data-redirect="{{ route('one-time-login') }}"
                            action="{{ route('password.send') }}" method="POST">
                            @csrf
...
@push('scripts')
    <script src="{{ theme_asset('js/pages/forgot-password.js') }}?v=51"></script>
@endpush
