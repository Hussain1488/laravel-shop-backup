                        ...
                        <form id="register-form" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-row form-group">
                                <input type="text" name="first_name" class="input-ui pr-2"
                                    placeholder="{{ trans('front::messages.auth.enter-your-name') }}">
                            </div>
                            <div class="form-row-title">
                            ...
                            <div class="form-row form-group">
                                <input type="text" name="last_name" class="input-ui pr-2"
                                    placeholder="{{ trans('front::messages.auth.enter-your-fname') }}">
                            </div>
                            <div class="form-row-title">
                            ...
                            <div class="form-row form-group">
                                <input type="password" name="password_confirmation" class="input-ui pr-2"
                                    placeholder="{{ trans('front::messages.auth.repeat-your-password') }}">
                            </div>
                            ...
                            <div class="form-footer text-right mt-3">
                                <span
                                    class="d-block font-weight-bold">{{ trans('front::messages.auth.have-you-registered-before') }}</span>
                                <a href="{{ route('login') }}"
                                    class="d-inline-block mr-3 mt-2">{{ trans('front::messages.auth.enter') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{ theme_asset('js/pages/register.js') }}?v=51"></script>
@endpush
