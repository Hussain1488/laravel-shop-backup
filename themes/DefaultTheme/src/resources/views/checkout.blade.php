                            ...
                            <div class="form-ui dt-sl pt-4 pb-4 checkout-div">
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        <div id="order-reserve-container" data-action="{{ route('front.reserve-cart') }}"
                                            ...
                                            @if (option('reserve_orders_enabled'))
                                                <div class="custom-control custom-radio pr-0 pl-3">
                                                    <input type="radio" class="custom-control-input" name="reserve"
                                                        id="reserve1" value="reserve"
                                                        {{ $cart->reserved() ? 'checked' : '' }}>
                                            ...
                                            @if (option('reserve_orders_enabled') || $reserved_orders->count())
                                                @if ($reserved_orders->count())
                                                    <div class="custom-control custom-radio  pr-0 pl-3">
                                                        <input type="radio" class="custom-control-input" name="reserve"
                                                            id="reserve2" value="send_reserved_orders"
                                                            {{ $cart->send_reserved_orders ? 'checked' : '' }}>
                                                        ...
                                                        <div class="my-3">
                                                            @foreach ($reserved_orders as $reserved_order)
                                                                <a target="_blank"
                                                                    ...
                                                                    <span class="mx-2">سفارش شماره
                                                                        {{ $reserved_order->id }}</span>
                                                                </a>{{ $loop->last ? '' : ' و ' }}
                                                            @endforeach
                                                        </div>
                                                    @endif
...
@push('scripts')
    ...
    <script src="{{ theme_asset('js/pages/checkout.js') }}?v=514"></script>
@endpush
