            ...
            <div class="col-md-6 col-sm-12">
                <div class="comments-summary-note">
                    ...
                    <div class="dt-sl mt-2 mb-4">
                        ...
                        @else
                            <a href="{{ route('login', ['redirect', route('front.products.show', ['product' => $fitting->product])]) }}" class="btn-primary-cm btn-with-icon">
                                <i class="mdi mdi-comment-text-outline"></i>
                                {{ trans('front::messages.reviews.add-review') }}
                            </a>
                        @endif
        ...
        @if ($reviews->count())
            <div class="comments-area dt-sl">
                <div class="section-title text-sm-title title-wide no-after-title-wide mb-0 dt-sl">
                    ...
                    <p class="count-comment"><span class="rate-product">{{ trans('front::messages.reviews.reviews-count', ['rating' => $fitting->product->rating, 'review_count' => $fitting->product->reviews_count]) }}</span></p>
                </div>
