<!-- Modal -->
<div class="modal fade" data-action="{{ route('front.reviews.show', ['product' => $fitting->product]) }}"
    id="add-product-review-modal" tabindex="-1" aria-labelledby="add-product-review-label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>{{ $fitting->product->title }}</p>
                <hr>
                <div class="row comments-add-col--content">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-ui">
                            <form id="add-product-review-form" action="{{ route('front.reviews.store') }}"
                                class="px-2" method="post">
                                <input type="hidden" name="product_id" value="{{ $fitting->product->id }}">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-row-title mb-2">{{ trans('front::messages.reviews.rate') }}
                                    ...
                                    <div class="col-12">
                                        <div class="form-row-title mb-2">{{ trans('front::messages.reviews.title') }}
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="form-row-title mb-2">{{ trans('front::messages.reviews.body') }}
                                            <span class="text-danger">*</span>
                                        </div>
                                        <div class="form-row">
                                    ...
                                    @if (auth()->user()->hasBoughtProduct($fitting->product))
                                        <div class="col-12 mt-3">
                                            <div class="product-offer-question">
                                                <div class="form-row-title mb-2">
                                                    {{ trans('front::messages.reviews.suggest-text') }}</div>
                                                <div class="product-review-suggest">

                                                    <input type="radio" id="review-suggest-yes" name="suggest"
                                                        value="yes">
                                                    ...
                                                    <input type="radio" id="review-suggest-not-sure" name="suggest"
                                                        value="not_sure">
                                                    <div class="review-suggest-item">
                                                    ...
                                                    <input type="radio" id="review-suggest-no" name="suggest"
                                                        value="no">
                                                    <div class="review-suggest-item">
                                                        <label for="review-suggest-no">
                                                            <i class="mdi mdi-thumb-down-outline"></i>
                                                            <p>{{ trans('front::messages.reviews.i-dont-suggest') }}
                                                            </p>
                                                        </label>
                                                    </div>
