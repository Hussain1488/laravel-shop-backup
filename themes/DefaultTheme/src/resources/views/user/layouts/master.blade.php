                    ...
                    <div class="profile-sidebar dt-sl">
                        <div class="dt-sl dt-sn mb-3">
                            <div class="profile-sidebar-header dt-sl">
                                ...
                                <div title="{{ trans('front::messages.currency.prefix') . convert_number($user->wallet->balance ?? 0) . trans('front::messages.currency.suffix') }}"
                                    ...
                                    <div class="float-left label-profile-point"><strong
                                            class="">{{ trans('front::messages.currency.prefix') }}{{ number_format($user->Wallet->balance ?? 0) }}</strong>
                                ...
                                <div class="profile-link mt-2 dt-sl">
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-center">
                                            <a href="{{ route('front.fitting.index') }}"
                                                class="{{ active_class('front.fitting.index') }}">
                                                <i class="mdi mdi-face"></i>
                                                {{ trans('front::messages.header.virtual_fitting') }}
                                            </a>
                                        </div>
                                        <div class="col-4 text-center">
                            ...
                            <div class="dt-sl dt-sn mb-3 py-4 px-3">
                                <div class="profile-sidebar-header dt-sl">
                                    <p>با دعوت از دوستان تان به {{ option('info_site_title') }}
                                        <b>{{ option('owner_refrral_amount', 0) }}</b> درصد کد تخفیف بگیرید.
                                    </p>
                                    <span>کد معرفی شما:</span><strong class="text-info">
                                        {{ $user->referral_code }}</strong>
                                </div>
                            </div>
                        @endif
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{ route('front.user.profile') }}"
                                                class="{{ active_class('front.user.profile') }}">
                                        ...
                                        <li>
                                            <a href="{{ route('front.user.password') }}">
                                                ...
                                                <span
                                                    class="d-block">{{ trans('front::messages.profile.change-password') }}</span>
                                            </a>
                                        ...
                                        <li>
                                            <a href="{{ route('front.user.comments') }}"
                                                class="{{ active_class('front.user.comments') }}">
                                        ...
                                        <li>
                                            <a href="{{ route('front.reviews.index') }}"
                                                class="{{ active_class('front.reviews.index') }}">
                                        ...
                                        <li>
                                            <a href="{{ route('front.match.index') }}"
                                                class="{{ active_class('front.match.index') }}">
                                                <i class="mdi mdi-heart-outline"></i>
                                                {{ trans('front::messages.profile.match') }}
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{ route('front.user.profile.edit') }}"
                                                class="{{ active_class('front.user.profile.edit') }}">
