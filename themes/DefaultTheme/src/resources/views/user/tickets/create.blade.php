        ...
        <div class="px-3 px-res-0">
            ...
            <div class="dt-sl dt-sn pt-4">
                <div class="col-12 col-md-10 offset-md-1">
                    <form class="form" id="ticket-create-form" data-redirect="{{ route('front.tickets.index') }}"
                        action="{{ route('front.tickets.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit"
                                        class="btn btn-primary mr-1 mb-1 waves-effect waves-light">{{ trans('front::messages.partials.create-ticket') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
