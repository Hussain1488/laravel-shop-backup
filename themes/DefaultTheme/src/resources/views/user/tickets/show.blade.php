        ...
        <div class="dt-sl dt-sn pt-4">
            <div class="col-12 col-md-10 offset-md-1">
                <form class="form" id="ticket-update-form"
                    data-redirect="{{ route('front.tickets.show', ['ticket' => $ticket]) }}"
                    action="{{ route('front.tickets.update', ['ticket' => $ticket]) }}" method="post"
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit"
                                    class="btn btn-primary mr-1 mb-1 waves-effect waves-light">{{ trans('front::messages.partials.record-message') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
