                        ...
                        <div class="col-12 d-flex">
                            ...
                            <div class="d-flex">
                                <p class="text-primary font-weight-bold mx-2 mb-2">
                                    {{ trans('front::messages.products.review') }} {{ $product->reviews_count }}</p>
                                <p class="text-primary font-weight-bold mx-2 mb-2">
                                    {{ trans('front::messages.products.comment-count') }}
                                    {{ $product->comments()->accepted()->count() }}</p>
                            </div>
                        </div>
                    @endif
                ...
                @if ($product->isPhysical())
                    <div class="card box-card px-3 pb-3 pt-0 testing-container">
                                            ...
                                            @foreach ($product->get_attributes($attributeGroup, $prev_attribute, $groups, $attributes_id) as $attribute)
                                                @php
                                                    if ($group_loop != 0 && count($prev_selected_attr)) {
                                                        $has_stock = $product->hasAttributeStock(
                                                            $attribute,
                                                            $prev_selected_attr,
                                                        );
                                                    } else {
                        ...
                        @if ($get_child->isEmpty())
                            ...
                            <div class="mt-3" style="margin-top:2px;">
