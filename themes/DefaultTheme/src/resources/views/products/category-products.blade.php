        ...
        <div class="container main-container">
                ...
                <div class="title-breadcrumb-special dt-sl mb-3">
                    <div class="breadcrumb dt-sl">
                        <nav>
                            ...
                            <a
                                href="{{ route('front.products.index') }}">{{ trans('front::messages.products.products') }}</a>
            ...
            <div class="row">
                ...
                <div id="category-products-div"
                    data-action="{{ route('front.products.category-products', ['category' => $category]) }}"
                    class="{{ $category->getFilter() ? 'col-lg-9' : 'col-lg-12' }} col-md-12 col-sm-12">
                    @if ($products->count())
                            ...
                            <div class="row">
                                <div class="products-list-sort-type ah-tab-wrapper dt-sl">
                                    <div class="ah-tab dt-sl">
                                        <a class="ah-tab-item" data-sort="latest"
                                            {{ request('sort_type') == 'latest' || !request('sort_type') ? 'data-ah-tab-active=true' : '' }}
                                            href="#">{{ trans('front::messages.categories.the-newest') }}</a>
                                        <a class="ah-tab-item" data-sort="view"
                                            {{ request('sort_type') == 'view' ? 'data-ah-tab-active=true' : '' }}
                                            href="#">{{ trans('front::messages.categories.the-most-visited') }}</a>
                                        <a class="ah-tab-item" data-sort="sale"
                                            {{ request('sort_type') == 'sale' ? 'data-ah-tab-active=true' : '' }}
                                            href="#">{{ trans('front::messages.categories.bestselling') }}</a>
                                        <a class="ah-tab-item" data-sort="cheapest"
                                            {{ request('sort_type') == 'cheapest' ? 'data-ah-tab-active=true' : '' }}
                                            href="#">{{ trans('front::messages.categories.cheapest') }}</a>
                                        <a class="ah-tab-item" data-sort="expensivest"
                                            {{ request('sort_type') == 'expensivest' ? 'data-ah-tab-active=true' : '' }}
                                            href="#">{{ trans('front::messages.categories.most-expensive') }}</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row mt-2">
                    <div class="dt-sl dt-sn search-amazing-tab mb-3 mx-3">
                        <div class="row">
                            ...
                            <div class="col-md-12 p-md-5 category-background"
...
@push('scripts')
    ...
    <script src="{{ theme_asset('js/pages/products/category.js') }}?v=51"></script>
