...
$(document).on('click', '.show-review', function () {
    $.ajax({
        ...
        type: 'GET',
        success: function (data) {
            $('#shop-review-detail').empty();
            $('#shop-review-detail').append(data);
...
$(document).on('submit', '#shop-review-edit-form', function (e) {
    e.preventDefault();
...
$(document).on('click', '#shop-review-form-submit-btn', function () {
    $('#shop-review-edit-form').trigger('submit');
});
